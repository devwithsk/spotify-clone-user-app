  ...
  return (
    <div className='w-full bg-black h-15 flex justify-between'>
        ...
        <div className='flex justify-center items-center'>
            ...
            {/* home icon */}
            <div className='w-10 h-10 rounded-full flex justify-center items-center bg-[#1F1F1F]'>
